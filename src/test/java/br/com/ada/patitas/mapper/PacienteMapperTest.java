...
public class PacienteMapperTest {
    ...
    public void testaToDtoPaciente() {
        Paciente paciente1 = new Paciente(1l, "lolo", Especie.CACHORRO, "viralata", 5, 25.5);
        ...
        assertEquals(Especie.CACHORRO, pacienteDtos.get(0).getEspecie());
    ...
    public void testaToDtoPacienteDto() {
        Paciente paciente = new Paciente(1l, "lolo", Especie.CACHORRO, "viralata", 5, 25.5);
        ...
        assertEquals(Especie.CACHORRO, pacienteDto.getEspecie());
 ...
 assertEquals(5, pacienteDto.getIdade());
    ...
    public void testaToEntityPaciente() {
        PacienteDto pacienteDto = new PacienteDto("lolo", Especie.CACHORRO, "viralata", 5, 25.5);

        Paciente paciente = PacienteMapper.toEntityPaciente(pacienteDto);

        assertNotNull(paciente);
        assertEquals("lolo", paciente.getNome());
        assertEquals(Especie.CACHORRO, paciente.getEspecie());
