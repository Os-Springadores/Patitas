...
public class VeterinarioMapperTest {
    ...
    public void testaToDtoVeterinario() {
        Veterinario veterinario1 = new Veterinario(1l,"Dr. Israel", Especialidade.CIRURGIA);
        ...
        assertEquals(Especialidade.CIRURGIA, veterinarioDtos.get(0).getEspecialidade());
    ...
    public void testaToDtoVeterinarioDto() {
        Veterinario veterinario = new Veterinario(1l,"Dr. Israel",Especialidade.CIRURGIA);
        ...
        assertEquals(Especialidade.CIRURGIA, veterinarioDto.getEspecialidade());
    }

    @Test
    public void testaToEntityVeterinario() {
        VeterinarioDto veterinarioDto = new VeterinarioDto("Dr. Israel", Especialidade.CIRURGIA);
        ...
        assertEquals(Especialidade.CIRURGIA, veterinario.getEspecialidade());
    }
}