...
public class CrudApplicationIntegrationTest {
    ...
    public void deveInserirUmaConsulta() {
        ...
        assertEquals(consultaOptional.get().getPaciente(),1l);
        assertEquals(consultaOptional.get().getVeterinario(),1l); 
        assertEquals(consultaOptional.get().getHorariosDisponiveis(),1l);
